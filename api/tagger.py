...
def extract_tags_with_ai(resume_text: str):
    ...
    - give search keywords for fitting jobs with respect to education and skills
    - give search keywords for fitting jobs with respect to jobtitles
    ...
    _save_user_tags(structured_data, test_user_id)
...
def tag_match_description_with_ai(education, job_title, skills, job_description):
    ...
    - Be honest about gaps. If they don't have LabVIEW and the job requires it, list that as a major gap.
